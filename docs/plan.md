...
- [ ] Счётчик упоминаний стиха в заметках + шторка со списком заметок
- [ ] Полная глава в шторке стиха со скроллом к нужному стиху
- [ ] Правка ссылки в заметке тапом по стиху в шторке
- [ ] Сохранение выделенных стихов в новую или существующую заметку

### Фаза 14 — Молитвенный журнал
[План](superpowers/plans/2026-09-05-phase14-prayer-journal.md) · 13 задач
- [ ] Сущности, миграция 2→3, DAO, репозиторий
- [ ] Бизнес-логика: действия над просьбой, подборка «на сегодня», напоминания
- [ ] Четвёртая вкладка и семь экранов
